...
describe("in-session-commands", () => {
  ...
  beforeEach(() => {
    ...
    db.insert(tasksTable)
      .values([
        { id: "t-1", sessionId: "s_cmd", title: "First task", description: "D1", status: "done", reviewVerdict: "approve", reviewCycles: 1, order: 1, createdAt: now, updatedAt: now },
        { id: "t-2", sessionId: "s_cmd", title: "Second task", description: "D2", status: "running", order: 2, createdAt: now, updatedAt: now },
        { id: "t-3", sessionId: "s_cmd", title: "Third task", description: "D3", status: "queued", order: 3, createdAt: now, updatedAt: now },
      ])
      .run();
  });
